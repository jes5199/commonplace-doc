...
use commonplace_doc::sync::{
    ...
    create_yjs_text_update, detect_from_path, directory_watcher_task, encode_node_id,
    file_watcher_task, is_allowed_extension, is_binary_content, normalize_path, refresh_from_head,
    scan_directory, scan_directory_with_contents, schema_to_json, sse_task, DirEvent, EditRequest,
    EditResponse, FileEvent, ForkResponse, HeadResponse, ReplaceResponse, ScanOptions, SyncState,
