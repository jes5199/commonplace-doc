//! commonplace-who: List all active presence files in the workspace
//!
//! Like Unix `who` — shows who's connected to this workspace.
//!
//! Usage:
//!   commonplace-who              # Show all presence files
//!   commonplace-who -n jes       # Filter by name
//!   commonplace-who --json       # JSON output

use clap::Parser;
use commonplace_doc::cli::WhoArgs;
use commonplace_doc::workspace::find_workspace_root;
use commonplace_types::fs::actor::ActorIO;

fn main() -> Result<(), Box<dyn std::error::Error>> {
    let args = WhoArgs::parse();
