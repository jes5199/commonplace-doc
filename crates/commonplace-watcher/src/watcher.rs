...
#[cfg(unix)]
use crate::flock::{try_flock_shared, FlockResult};
use crate::WrittenSchemas;
...
pub struct ShadowWriteEvent {
    ...
    pub inode_key: crate::state::InodeKey,
...
#[cfg(unix)]
pub async fn shadow_gc_task(tracker: Arc<RwLock<crate::state::InodeTracker>>) {
